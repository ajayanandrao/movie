...
import VikingPageTow from './VikingPageTow';
import MovieJson from './vikings.json';
            ...
            <div className="container py-3" style={{ backgroundColor: "#212121" }}>
                ...
                <div className="container MoviePageDescription-Two my-5">
                    ...
                    <div className=" MoviePageDescription d-flex flex-column ">
                        ...
                        <img className='MoviePageImg mt-4' src="https://myimg.bid/images/2022/02/25/Vikings-Valhalla-S01-Hindi-HDRip-ALL-Episodes.jpg" />
                    ...
                    <div className="iframe-div">
                        <iframe className="iframe" width="560" height="315" src="https://www.youtube.com/embed/q3HEQsu_s3M" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
