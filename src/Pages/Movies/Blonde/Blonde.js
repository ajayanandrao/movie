...
import BlondePageTow from './BlondePageTow';
import MovieJson from './Blonde.json';
     ...
     <div className="container py-3" style={{ backgroundColor: "#212121" }}>
                ...
                <div className="container MoviePageDescription-Two my-5">
                    ...
                    <div className=" MoviePageDescription d-flex flex-column ">
                        ...
                        <img className='MoviePageImg mt-4' src="https://image.tmdb.org/t/p/original/jOgbnL5FB30pprEjZaY1E1iPtPM.jpg" />
                    ...
                    <div className="iframe-div">
                        <iframe className="iframe" width="560" height="315" src="https://www.youtube.com/embed/VnI2MyS6fgo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <hr className='hr' />
