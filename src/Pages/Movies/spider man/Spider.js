...
import MovieJson from './SipderMan.json';
import SpiderPageTow from './SpiderPageTow';
            ...
            <div className="container py-3" style={{ backgroundColor: "#212121" }}>
                ...
                <div className="container MoviePageDescription-Two my-5">
                    ...
                    <div className=" MoviePageDescription d-flex flex-column ">
                        ...
                        <img className='MoviePageImg mt-4' src="https://myimg.bid/images/2022/03/11/SpiderMan-No-Way-Home-2021-English-HDRip-Full-Movie.jpg" />
                    ...
                    <div className="iframe-div">
                        <iframe className="iframe" width="560" height="315" src="https://www.youtube.com/embed/rt-2cxAiPJk" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
