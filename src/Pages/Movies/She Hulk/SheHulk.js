...
import MovieJson from './Shehulk.json';
import SheHulkPageTow from './SheHulkPageTow';
            ...
            <div className="container py-3" style={{ backgroundColor: "#212121" }}>
                ...
                <div className="container MoviePageDescription-Two my-5">
                    ...
                    <div className=" MoviePageDescription d-flex flex-column ">
                        ...
                        <img className='MoviePageImg mt-4' src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcS7IHDYK6j6jXB-fL7t29KTmhQ25QeomqG0_ikmQCZlEOjHNiZe" />
                    ...
                    <div className="iframe-div">
                        <iframe className="iframe" width="560" height="315" src="https://www.youtube.com/embed/gim2kprjL50" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                    </div>
                    <hr className='hr' />
